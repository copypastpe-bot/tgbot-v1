...
# Ноль означает «поле в CRM ещё не заведено»: тогда метки просто нет, и робот
# работает как раньше. Молчаливо считать непроставленный номер совпадением
# нельзя — так робот замолчал бы по всем заказам разом.
AMO_FIELD_OWNER_HANDLES = 1461165
